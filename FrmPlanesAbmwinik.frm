...
Begin VB.Form FrmPlanesAbm 
   ...
   Begin VB.Frame fmeVtos 
      ...
      Top             =   3480
      Width           =   7215
      Begin VB.ComboBox cmbDesde3 
         Height          =   315
         ItemData        =   "FrmPlanesAbm.frx":0A02
         Left            =   720
         List            =   "FrmPlanesAbm.frx":0A09
      ...
      Begin VB.TextBox txtVto3 
         ...
         Width           =   495
      End
      Begin VB.ComboBox CmbHasta3 
         Height          =   315
         ItemData        =   "FrmPlanesAbm.frx":0A10
         Left            =   2400
         List            =   "FrmPlanesAbm.frx":0A71
         Style           =   2  'Dropdown List
         TabIndex        =   105
         Top             =   1320
         Width           =   975
      End
      Begin VB.TextBox txtsegvto3 
         Height          =   285
         Left            =   5520
         MaxLength       =   2
         TabIndex        =   104
         ...
         Width           =   495
      End
      Begin VB.ComboBox cmbDesde2 
         Height          =   315
         ItemData        =   "FrmPlanesAbm.frx":0AE8
         Left            =   720
         List            =   "FrmPlanesAbm.frx":0AEF
         Style           =   2  'Dropdown List
         TabIndex        =   99
         ToolTipText     =   "Frecuencia de vencimientos de cuotas (MENSUAL,DIARIO, etc)"
         Top             =   960
      ...
      Begin VB.TextBox txtVto2 
         ...
         Width           =   495
      End
      Begin VB.ComboBox CmbHasta2 
         Height          =   315
         ItemData        =   "FrmPlanesAbm.frx":0AF6
         Left            =   2400
         List            =   "FrmPlanesAbm.frx":0B57
         Style           =   2  'Dropdown List
         TabIndex        =   97
         Top             =   960
         Width           =   975
      End
      Begin VB.TextBox txtsegvto2 
         Height          =   285
         Left            =   5520
         MaxLength       =   2
         TabIndex        =   96
         ...
         Width           =   495
      End
      Begin VB.ComboBox cmbDesde1 
         Height          =   315
         ItemData        =   "FrmPlanesAbm.frx":0BCE
         Left            =   720
         List            =   "FrmPlanesAbm.frx":0BD5
         Style           =   2  'Dropdown List
         TabIndex        =   91
         ToolTipText     =   "Frecuencia de vencimientos de cuotas (MENSUAL,DIARIO, etc)"
         Top             =   600
      ...
      Begin VB.TextBox txtVto1 
         ...
         Width           =   495
      End
      Begin VB.ComboBox CmbHasta1 
         Height          =   315
         ItemData        =   "FrmPlanesAbm.frx":0BDC
         Left            =   2400
         List            =   "FrmPlanesAbm.frx":0C3D
         Style           =   2  'Dropdown List
         TabIndex        =   89
         Top             =   600
         Width           =   975
      End
      Begin VB.TextBox txtsegvto1 
         Height          =   285
         Left            =   5520
         MaxLength       =   2
         TabIndex        =   88
      ...
      Begin VB.ComboBox CmbHasta 
         Height          =   315
         ItemData        =   "FrmPlanesAbm.frx":0CB4
         Left            =   2400
         List            =   "FrmPlanesAbm.frx":0D15
         Style           =   2  'Dropdown List
         TabIndex        =   83
         Top             =   240
         Width           =   975
      ...
      Begin VB.ComboBox cmbDesde 
         Height          =   315
         ItemData        =   "FrmPlanesAbm.frx":0D8C
         Left            =   720
         List            =   "FrmPlanesAbm.frx":0D93
         Style           =   2  'Dropdown List
         TabIndex        =   80
         ToolTipText     =   "Frecuencia de vencimientos de cuotas (MENSUAL,DIARIO, etc)"
         Top             =   240
   ...
   Begin VB.Frame fmeDatos 
      ...
      Begin VB.CheckBox CheckPredeterminada 
         ...
         Width           =   1455
      End
      Begin VB.TextBox txtPorcEntrega 
         Height          =   285
         Left            =   4440
         MaxLength       =   2
         TabIndex        =   77
      ...
      Begin VB.ComboBox ComboTem 
         Height          =   315
         ItemData        =   "FrmPlanesAbm.frx":0D9A
         Left            =   1680
         List            =   "FrmPlanesAbm.frx":0DA4
         Style           =   2  'Dropdown List
         TabIndex        =   6
      ...
      Begin VB.ComboBox ComboVencimientos 
         Height          =   315
         ItemData        =   "FrmPlanesAbm.frx":0DBD
         Left            =   1680
         List            =   "FrmPlanesAbm.frx":0DD0
         Style           =   2  'Dropdown List
         TabIndex        =   4
         ToolTipText     =   "Frecuencia de vencimientos de cuotas (MENSUAL,DIARIO, etc)"
         Top             =   1440
      ...
      Begin MSComCtl2.UpDown UpDown3 
         ...
         Enabled         =   -1  'True
      End
      Begin VB.Label lblporcentrega 
         AutoSize        =   -1  'True
         Caption         =   "Porcentaje Prod con Entrega:"
         Height          =   195
         Index           =   0
         Left            =   2280
         TabIndex        =   78
...
Else
   ...
   sql = "UPDATE planes SET nombre='" & CStr(TxtNombre.Text) & "',tasa1=" & ConvertirDblSql(CDbl(TxtTasa1.Text)) & _
         ...
         ",diasvencimiento=" & CLng(DiasVencimiento) & ",predeterminada=" & CheckPredeterminada(0).Value & _
         ...
         ",PorcProdEntre=" & ConvertirDblSql(CCur(txtPorcEntrega.Text)) & _
...
sql = "SELECT planes.IDplan,planes.nombre AS 'plan'," & _
      ...
      "planes.aplicarseguro,planes.aplicarseguroscuota1,planes.noaplicarsegurosrefinanciacion,planes.importeseguro,planes.alicuotaseguros,planes.importesegurosfijos,planes.porcprodentre" & _
      " FROM planes " & _
      "WHERE Idplan=" & CLng(lv.SelectedItem)
...
If Not rec.EOF Then
   ...
   txtPorcEntrega.Text = rec.rdoColumns("porcprodentre") & vbNullString
   ...
   If rec.rdoColumns("predeterminada") Then
      CheckPredeterminada(0).Value = 1
   Else
      CheckPredeterminada(0).Value = 0
   End If
...
'valido porcentaje producto con entrega
If Trim(txtPorcEntrega.Text) = "" Then
   datosok = False
   MsgE "Debe ingresar el porcentaje con entrega"
   txtPorcEntrega.SetFocus
   Exit Function
End If
If Not IsNumeric(txtPorcEntrega.Text) Then
   datosok = False
   MsgE "El Porcentaje de Producto con Entrega debe ser numerico"
   txtPorcEntrega.SetFocus
   Exit Function
End If
'If CDbl(txtPorcEntrega.Text) < 0 Then
'   datosok = False
'   MsgE "La cantidad de cuotas debe ser mayor a cero"
'   txtPorcEntrega.SetFocus
'   Exit Function
