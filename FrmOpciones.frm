...
Begin VB.Form FrmOpciones 
   ...
   Begin VB.Frame FrameRequisitos 
      ...
      Begin VB.TextBox txtMontoMora 
         ...
         Width           =   1335
      End
      Begin VB.TextBox txtAntiguedadMora 
         Alignment       =   1  'Right Justify
         Height          =   285
         Left            =   7080
         MaxLength       =   3
      ...
      Begin VB.Label Label37 
         Caption         =   "Monto máximo de Mora admitida"
         Height          =   255
         Left            =   4440
         TabIndex        =   203
         Top             =   5280
      ...
      Begin VB.Label Label36 
         Caption         =   "Antiguedad Mora admitida (meses)"
         Height          =   255
         Left            =   4440
         TabIndex        =   201
         Top             =   4920
      ...
      Begin VB.Label Label35 
         Caption         =   "Tiempo de inactividad para Logout automático:"
         Height          =   255
         Left            =   3480
         TabIndex        =   199
         Top             =   4200
      ...
      Begin VB.Label Label34 
         Caption         =   "Cantidad Días de Mora admitida"
         Height          =   255
         Left            =   360
         TabIndex        =   197
         Top             =   5280
      ...
      Begin VB.Label Label32 
         Caption         =   "Fecha límite de vencimiento:"
         Height          =   255
         Left            =   360
         TabIndex        =   193
         Top             =   4200
...
txtCantDias.Text = VG_CANT_DIAS
FecLimite.Value = VG_FECHALIMITEINGRESO
txtMora.Text = VG_DIAS_MORA
txtAntiguedadMora.Text = VG_ANTIGUEDAD_MORA
txtMontoMora.Text = VG_MONTO_MORA
txtLogout.Text = VG_TIEMPO_LOGOUT
...
If Trim(txtCantDias.Text) = "" Then
   DatosRequisitosOk = False
   MsgE "Ingrese cantidad de dias de fecha limite de Vencimiento"
   txtCantDias.SetFocus
   Exit Function
End If
  
If Not IsNumeric(Trim(txtCantDias.Text)) Then
   DatosRequisitosOk = False
   MsgE "Ingrese cantidad de dias de fecha limite de Vencimiento"
   txtCantDias.SetFocus
   Exit Function
...
If Trim(txtMora.Text) = "" Then
   DatosRequisitosOk = False
   MsgE "Ingrese cantidad de dias de Mora admitida"
   txtMora.SetFocus
   Exit Function
End If
 
If Trim(txtAntiguedadMora.Text) = "" Then
   DatosRequisitosOk = False
   MsgE "Ingrese la antiguedad de Mora admitida"
   txtMora.SetFocus
   Exit Function
End If
  
If Trim(txtMontoMora.Text) = "" Then
   DatosRequisitosOk = False
   MsgE "Ingrese el monto máximo de Mora admitida"
   txtMora.SetFocus
   Exit Function
End If
  
If Trim(txtLogout.Text) = "" Then
   DatosRequisitosOk = False
   MsgE "Ingrese tiempo para logout automático"
   txtLogout.SetFocus
   Exit Function
End If
   
If Not IsNumeric(Trim(txtLogout.Text)) Then
   DatosRequisitosOk = False
   MsgE "Tiempo para logout automático debe ser numérico"
   txtLogout.SetFocus
   Exit Function
End If
...
If TabStripopciones.SelectedItem.Index = 3 Then
   ...
   sql = "update configuracionsistema set garante=" & CheckGarante.Value & _
         ...
         ",CantDiasVenc=" & txtCantDias.Text & _
         ",fechalimite= '" & ConvertirFechaSql(CDate(FecLimite), "DD/MM/YYYY") & _
         "',cobrosdiferidos=" & CheckCobrosDiferidos.Value & _
         ",CantDiasMora=" & txtMora.Text & _
         ",AntiguedadMora=" & txtAntiguedadMora.Text & _
         ",MontoMinimoMora=" & txtMontoMora.Text & _
         ",TiempoLogout=" & txtLogout.Text
